...
| Projects page content | Tests assert Hey Jarvis replaces Home Guard TG in both languages; GitHub and internal-release links remain shared; each page includes only its matching-language demo; article and cross-language demo links are absent; and local-first/BYOK plus unsigned-release boundaries are preserved. |
