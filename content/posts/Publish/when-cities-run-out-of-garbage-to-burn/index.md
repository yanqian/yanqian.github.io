...
![A general waste bin beside a blue recycling bin in Singapore](assets/when-cities-run-out-of-garbage-to-burn/06-general-and-recycling-bins.jpg)
...
![Simplified route from Tuas waste facilities to Semakau Landfill](assets/when-cities-run-out-of-garbage-to-burn/04-tuas-semakau-waste-route.svg)
...
![Singapore waste system flow from daily waste to incineration, recovery, and Semakau](assets/when-cities-run-out-of-garbage-to-burn/05-singapore-waste-system-flow.svg)
...
![A blue recycling bin with instructions for paper, metal, plastic, and glass](assets/when-cities-run-out-of-garbage-to-burn/01-recycling-bin-close-up.jpg)
